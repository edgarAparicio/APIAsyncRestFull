...
namespace EdgarAparico.Data.APIAsyncRESTFull
{
    public class DbContextAPIAsyncRESTFull : DbContext
    {
        public DbSet<Book> Books { get; set; }

        public DbContextAPIAsyncRESTFull(DbContextOptions<DbContextAPIAsyncRESTFull> options) 
            : base(options)
        {

        }

        //Antes de .NET Core 2.1 el llenado de base de datos se hacia mediante una extension en el contexto que se llamaria al iniciar la aplicacion
        //Se llenaria la BD en caso de que estuviera vacia
        //Desde Entity FRamwork Core Core 2.1 introdujo el soporte incorporado para sembrar la BD.
        //Para sembrar la BD se sobreescribi el metodo OnModelCreating y se llama a la funcion HasData()
